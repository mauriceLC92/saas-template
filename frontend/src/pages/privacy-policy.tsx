export default function PrivacyPolicyPage() {
  return (
    <main className='mx-auto flex max-w-3xl flex-col gap-y-8 px-2 py-4'>
      ...
      <section className='text-muted-foreground space-y-2 text-sm'>
        ...
        <p>
          Our Service does not address anyone under the age of 13. We don&apos;t
          knowingly collect personally identifiable information from anyone
          under the age of 13. If You are a parent or guardian and You&apos;re
